...
class UserData
{
    ...
    public function update ()
    {
        $sql = "update " . self::$tablename .
                 " set name=\"$this->name\",unidad=\"$this->unidad\",lastname=\"$this->lastname\",username=\"$this->username\",email=\"$this->email\",kind=\"$this->kind\",status=\"$this->status\" where id=$this->id";
        Executor::doit($sql);
    }
    ...
    {
        $sql = "update " . self::$tablename .
                 " set name=\"$this->name\",unidad=\"$this->unidad\",lastname=\"$this->lastname\",bio=\"$this->bio\",address=\"$this->address\",phone=\"$this->phone\" where id=$this->id";
        Executor::doit($sql);
    }
